...
define LIBQUIRC_BUILD_CMDS
    $(TARGER_MAKE_ENV) $(MAKE) $(TARGET_CONFIGURE_OPTS) CFLAGS="-O3 -Wall -fPIC" SDL_CFLAGS="-D_GNU_SOURCE=1 -D_REENTRANT -I$(STAGING_DIR)/usr/include/SDL" SDL_LIBS="-lSDL" -C $(@D) all
endef
